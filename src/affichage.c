...
SDL_Surface* affichage_creation_unite(Case_terrain_espace *une_case_terrain_espace, SDL_Surface *panneau_unite)
{
    ...
    for(i=0;i<1;i++)
    {
        if((i == une_planete->unite_en_cours) && (une_planete->unite_nb_tour_restant != 0))
        {
